...
@section('content')
    <section class="content">
        ...
        <div class="card">
            ...
            <form action="{{ route('department.store') }}" method="post" data-bitwarden-watching="1" enctype="multipart/form-data" accept-charset="UTF-8">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Add New Department</label>
                        <input type="text" name="department_name" class="form-control @if($errors->has('department_name')) is-invalid @endif" value="{!! old('department_name') !!}" placeholder="Enter Department Name">
